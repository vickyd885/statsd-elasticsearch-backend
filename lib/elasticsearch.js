...
var caCert = fs.readFileSync("/etc/ssl/certs/ca-certificates.crt");
...
var es_bulk_insert = function elasticsearch_bulk_insert(listCounters, listTimers, listTimerData, listGaugeData) {
      ...
      if(elasticHost.startsWith("http://") || elasticHost.startsWith("https://")){
        elasticHost = elasticHost.replace("https://", "")
        elasticHost = elasticHost.replace("http://", "")
      }
